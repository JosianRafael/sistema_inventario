...
namespace CapaNegocio
{
    ...
    {
        public static string CN_Insertar_Proveedor(string nombre, string telefono, string direccion, string correo_electronico_proveedor, string nombre_representante)
        {
        ...
        public static string CN_Actualizar_Proveedor(int id_proveedor, string nombre, string telefono, string direccion, string correo_electronico_proveedor, string nombre_representante)
        {
