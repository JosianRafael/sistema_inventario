...
namespace sistema_inventario.Vistas.Inventario
{
    public partial class menuesinventario : Form
    {
        private void InitializeComponent()
        {
            ...
            string[] dashboardItems = { "Producto/Inventario", "Actualizar inventario", "Ver inventario", "Movimiento inventario" };
            string[] iconPaths = { "../../recursos/img/insertarinventario.png", "../../recursos/img/modificarinventario.png", "../../recursos/img/consultarinventario.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson.png", "recursos/img/inventario.png", "recursos/img/reporte.png", "recursos/img/participantes.png", "icons/check.png", "icons/expense.png", "icons/cashcut.png", "icons/transfer.png" };
