...
namespace sistema_inventario.vistaEmpleado
{
    public partial class menuesempleado : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            sectionTitle.Text = "👥 Gestión de Empleados";
            ...
            string[] dashboardItems = { "Crear Empleado", "Modificar Empleado", "Ver listas empleados", "Volver Panel Principal", "Modulos" };
            string[] iconPaths = { "../../recursos/img/crearempleado.png", "../../recursos/img/modificarempleado.png", "../../recursos/img/buscarempleado.png", "../../recursos/img/volveratras.png", "../../recursos/img/comingson.png" };
            ...
            for (int i = 0; i < dashboardItems.Length; i++)
            {
                ...
                buttonPanel.Click += (s, e) =>
                {
                    ...
                    {
                        case "Crear Empleado":
                            // newForm = new FormularioCrearEmpleado();
                            // MessageBox.Show("Abrir formulario de Crear Empleado");
                            break;
                        case "Modificar Empleado":
                            // newForm = new FormularioModificarEmpleado();
                           //  MessageBox.Show("Abrir formulario de Modificar Empleado");
                            break;
                        case "Ver listas empleados":
                            // newForm = new FormularioListaEmpleados();
                            // MessageBox.Show("Abrir lista de empleados");
                            break;
