...
namespace sistema_inventario.vistaCliente
{
    public partial class menuesCliente : Form
    {
        public void InitializeComponent()
        {
            ...
            string[] iconPaths = { "../../recursos/img/crearcliente.png", "../../recursos/img/modificarcliente.png", "../../recursos/img/verclientes.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson", "../../recursos/img/comingson" };
