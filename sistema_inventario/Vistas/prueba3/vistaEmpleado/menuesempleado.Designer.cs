...
namespace sistema_inventario.vistaEmpleado
{
    public partial class menuesempleado : Form
    {
        private void InitializeComponent()
        {
            ...
            string[] iconPaths = { "../../recursos/img/crearempleado.png", "../../recursos/img/modificarempleado.png", "../../recursos/img/buscarempleado.png", "../../recursos/img/comingson.png", "../../recursos/img/comingson.png", "recursos/img/inventario.png", "recursos/img/reporte.png", "recursos/img/participantes.png", "icons/check.png", "icons/expense.png", "icons/cashcut.png", "icons/transfer.png" };
