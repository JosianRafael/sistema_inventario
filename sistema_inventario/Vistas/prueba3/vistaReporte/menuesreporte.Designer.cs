...
namespace sistema_inventario.vistaReporte
{
    public partial class menuesreporte : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            string[] dashboardItems = { "Generador de reportes" };
            string[] iconPaths = { "../../recursos/img/reportgenerador.png", "../../recursos/img/modificarproveedor.png", "../../recursos/img/verlistaproovedor.png", "../../recursos/img/insertarproveedorproducto.png", "../../recursos/img/modificarproveedorproducto.png", "../../recursos/img/consultarproveedorproducto.png" };
