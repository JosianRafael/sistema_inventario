...
namespace sistema_inventario.vistaInventario
{
    public partial class menuesinventario : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            sectionTitle.Text = "📦 Gestión de Inventario";
            ...
            string[] dashboardItems = { "Producto/Inventario", "Actualizar inventario", "Ver inventario", "Movimiento inventario", "Volver Panel Principal" };
            string[] iconPaths = { "../../recursos/img/insertarinventario.png", "../../recursos/img/modificarinventario.png", "../../recursos/img/consultarinventario.png", "../../recursos/img/comingson.png", "../../recursos/img/volveratras.png", "recursos/img/inventario.png", "recursos/img/reporte.png", "recursos/img/participantes.png", "icons/check.png", "icons/expense.png", "icons/cashcut.png", "icons/transfer.png" };

            int x = 20, y = 20 + sectionTitle.Height + spaceBetweenTitleAndBoxes; // Ajustar la posición y
